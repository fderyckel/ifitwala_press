...
backup_dir="${pool_dir}/sites/${site_name}/private/backups"
...
backup_prefix="gs://${GCS_BACKUPS_BUCKET}/sites/${site_name}/daily/"
...
manifest_path="$(mktemp "/tmp/ifitwala-shared-backup-manifest.XXXXXX.json")"
jq -n \
